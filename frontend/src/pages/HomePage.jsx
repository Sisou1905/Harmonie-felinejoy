...
const ProdCard = ({ img, name, sub, star, link }) => (
  <a href={link || "https://felinejoycamy.myshopify.com"} target="_blank" rel="noopener noreferrer"
    ...
    <div className="p-2.5">
      ...
      <div className="text-sm font-medium text-emerald-700 mt-1.5 underline">Decouvrir</div>
    </div>
  </a>
);
...
const HomePage = () => {
  ...
  useEffect(() => {
    const fetchArticles = async () => {
      try {
        const r = await fetch(`${API}/articles?limit=10`);
  ...
  const fallback = [
    { title: "3 mois d'Omega-3 pour mieux dormir et reduire le stress", category: "Science", excerpt: "Une etude relayee par Science & Vie revele qu'une cure de 3 mois d'Omega-3 transforme votre equilibre mental.", image_url: "https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=600&q=80", slug: "#", reading_time: 6, amazon_url: "https://www.amazon.fr/s?k=omega+3+complement&tag=sissoulily-21" },
    { title: "Comment votre chat ressent votre anxiete", category: "Bien-être animal", excerpt: "Les chats percoivent les changements physiologiques de leurs proprietaires.", image_url: "https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?w=600&q=80", slug: "#", reading_time: 4, amazon_url: null },
    { title: "Le lien humain-animal reduit le cortisol de 23%", category: "Lien", excerpt: "Des etudes scientifiques confirment ce que nous ressentons.", image_url: "https://images.unsplash.com/photo-1548802673-380ab8ebc7b7?w=600&q=80", slug: "#", reading_time: 5, amazon_url: null },
  ];
    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <section>
        <div className="relative h-72 md:h-96 overflow-hidden">
          <img
            src="https://images.unsplash.com/photo-1476231682828-37e571bc172f?w=1400&q=85"
            alt="Foret avec riviere paisible pour la meditation"
      ...
      <section className="px-5 md:px-8 py-6 max-w-5xl mx-auto">
        ...
        <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}
          ...
          <div className="p-4 md:p-6">
            ...
            <h3 className="font-medium text-amber-900 mb-3">Masque Nila & Fromage Blanc</h3>
            ...
            <div className="space-y-2 mb-4">
              {[
                "Mélangez 2 c. à café de Nila avec 2 c. à soupe de fromage blanc 3%.",
                "Appliquez sur le visage après la douche — les pores sont dilatés.",
                "Laissez poser 20 minutes, rincez. 1 fois par semaine.",
              ].map((step,i)=>(
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}
            ...
            <div className="flex items-center gap-2 bg-emerald-800 text-white rounded-xl px-4 py-2.5 mb-4">
              ...
              <p className="text-xs font-medium"><strong>Prix partenaire exclusif</strong> — jusqu'à 30% de réduction vs prix public</p>
            </div>
            <div className="md:flex gap-6">
              <div className="flex gap-3 items-center mb-4 md:mb-0 md:flex-col md:items-center md:w-40 md:flex-shrink-0">
                <img src="https://zinzinowebstorage.blob.core.windows.net/productimages/large/300000.png" alt="Zinzino BalanceOil+"
                  loading="lazy" className="w-16 h-20 md:w-24 md:h-28 object-contain bg-white rounded-xl p-1 border border-emerald-100 flex-shrink-0"
              ...
              <div className="flex-1">
                ...
                <div className="bg-white border border-emerald-100 rounded-xl p-3">
                  <p className="text-xs font-semibold text-emerald-800 text-center mb-3">Ratio Omega-6/3 avant et après 120 jours</p>
      ...
      <section className="px-5 md:px-8 py-6 max-w-5xl mx-auto">
        ...
        <p className="text-sm text-gray-500 leading-relaxed mb-4">Accessoires, jouets et t-shirts originaux pour chérir votre félin.</p>
        <motion.div variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true }}
      ...
      <section className="px-5 md:px-8 py-6 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-sm text-gray-500 leading-relaxed mb-4 max-w-2xl">La science confirme : notre lien avec nos animaux nous transforme profondément.</p>
          <div className="md:flex gap-6 mb-5">
            <div className="relative rounded-2xl overflow-hidden h-48 md:h-64 md:w-96 flex-shrink-0 mb-4 md:mb-0">
              <img src="https://images.unsplash.com/photo-1548802673-380ab8ebc7b7?w=800&q=80" alt="Lien humain-animal"
            ...
            <div className="flex-1">
              ...
              <div className="bg-white border border-violet-100 rounded-2xl p-4">
                ...
                <p className="text-sm italic text-violet-600 mb-2">"Que votre parole soit impeccable"</p>
                <p className="text-xs text-gray-500 leading-relaxed mb-2">Parlez à votre chat avec douceur. Observez comment il réagit à votre ton.</p>
      ...
      {amazonArticles.length > 0 && (
        <section className="px-5 md:px-8 py-6 max-w-5xl mx-auto">
          ...
          <h2 className="text-lg md:text-xl font-medium text-emerald-800 mb-1">Nos coups de coeur</h2>
          <p className="text-sm text-gray-500 leading-relaxed mb-4">Des produits sélectionnés en lien avec nos articles.</p>
