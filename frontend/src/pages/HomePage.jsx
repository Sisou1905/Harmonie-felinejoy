...
const ProdCard = ({ img, name, sub, price, star, link }) => (
  <a href={link || "https://felinejoycamy.myshopify.com"} target="_blank" rel="noopener noreferrer"
    ...
    {star && (
      <div className="bg-emerald-700 text-white text-center text-xs font-semibold py-1 tracking-wide">
        ⭐ BEST-SELLER
      </div>
    )}
...
const MasqueIllo = () => (
  <div className="w-full h-36 bg-gradient-to-br from-amber-50 to-stone-100 relative flex items-center justify-center overflow-hidden rounded-t-2xl">
    ...
    <div className="absolute left-12 top-4" style={{ transform: "rotate(-25deg)" }}>
      <div className="w-4 h-5 bg-gradient-to-b from-blue-600 to-indigo-800 rounded-t-full rounded-b-lg"
        style={{ boxShadow: "0 0 10px rgba(67,97,238,0.7)" }} />
    ...
    <div className="flex flex-col items-center ml-8">
      ...
      <div className="w-20 h-10 bg-gradient-to-b from-stone-50 to-stone-200 rounded-b-full border border-stone-300 relative overflow-hidden flex items-center justify-center">
        ...
        <div className="w-7 h-3 rounded-full absolute top-2 bg-gradient-to-r from-blue-600 to-indigo-700 opacity-90"
          style={{ boxShadow: "0 0 8px rgba(79,70,229,0.6)" }} />
      </div>
    </div>
    {[{ l: "52%", t: "30%", s: 5 }, { l: "60%", t: "22%", s: 3 }, { l: "65%", t: "40%", s: 4 }, { l: "45%", t: "55%", s: 3 }].map((d, i) => (
      <div key={i} className="absolute rounded-full bg-indigo-600"
        style={{ left: d.l, top: d.t, width: d.s, height: d.s, opacity: 0.75, boxShadow: "0 0 6px rgba(79,70,229,0.5)" }} />
    ))}
...
const HomePage = () => {
  ...
  useEffect(() => {
    ...
    if (meta) meta.setAttribute("content", "Blog bien-être : prendre soin de soi avec les Oméga-3 Zinzino prouvés scientifiquement, comprendre son chat, et célébrer le lien humain-animal.");
  }, []);
  ...
  const fallback = [
    {
      title: "3 mois d'Oméga-3 pour mieux dormir et réduire le stress",
      category: "Science",
      excerpt: "Une étude relayée par Science & Vie révèle qu'une cure de 3 mois d'Oméga-3 transforme votre équilibre mental.",
      image_url: "https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=600&q=80",
      slug: "#", reading_time: 6,
      amazon_url: "https://www.amazon.fr/s?k=omega+3+complement&tag=sissoulily-21"
    },
    {
      title: "Comment votre chat ressent votre anxiété — étude comportementale 2024",
      category: "Bien-être animal",
      excerpt: "Les chats perçoivent les changements physiologiques de leurs propriétaires avec une acuité surprenante.",
      image_url: "https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?w=600&q=80",
      slug: "#", reading_time: 4, amazon_url: null
    },
    {
      title: "Le lien humain-animal réduit le cortisol de 23%",
      category: "Lien",
      excerpt: "Des études scientifiques confirment ce que nous ressentons — notre relation avec nos animaux nous transforme.",
      image_url: "https://images.unsplash.com/photo-1548802673-380ab8ebc7b7?w=600&q=80",
      slug: "#", reading_time: 5, amazon_url: null
    },
  ];
    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <section>
        <div className="relative h-72 md:h-96 overflow-hidden">
          <img
            src="https://images.unsplash.com/photo-1516280440614-37939bbacd81?w=1400&q=85"
            alt="Personne enlacant son chat avec tendresse"
            className="w-full h-full object-cover"
            onError={e => e.target.src = "https://images.unsplash.com/photo-1543466835-00a7907e9de1?w=1400&q=80"}
          />
          <div className="absolute inset-0 bg-gradient-to-t from-emerald-900/80 via-black/20 to-transparent" />
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}
            className="absolute bottom-0 left-0 right-0 p-6 md:p-12 max-w-4xl">
            ...
            <h1 className="text-2xl md:text-4xl font-medium text-white leading-tight"
              ...
              chérir ce lien unique
            </h1>
          </motion.div>
        </div>

        <div className="bg-white px-5 md:px-8 pt-5 pb-6 max-w-5xl mx-auto">
          <p className="text-sm md:text-base text-gray-500 leading-relaxed mb-4 max-w-2xl">
      ...
      <section className="px-5 md:px-8 py-6 max-w-5xl mx-auto">
        ...
        <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}
          className="mt-6 bg-white rounded-2xl overflow-hidden border border-amber-100 md:flex">
      ...
      <section className="px-5 md:px-8 py-6 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-sm text-gray-500 leading-relaxed mb-5 max-w-2xl">
            Des laboratoires scandinaves indépendants analysent votre sang avant et après. Pas de promesses — des preuves. Via notre lien partenaire, bénéficiez de <strong className="text-emerald-700">prix avantageux jusqu'à 30% moins chers</strong> qu'en achat classique.
          </p>
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}
            className="bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-200 rounded-2xl p-4 md:p-6">

            <div className="flex items-center gap-2 bg-emerald-800 text-white rounded-xl px-4 py-2.5 mb-4">
              <Tag className="w-4 h-4 flex-shrink-0" />
              <p className="text-xs font-medium">
                <strong>Prix partenaire exclusif</strong> — jusqu'à 30% de réduction vs prix public · Livraison incluse
              </p>
            </div>
            ...
            <div className="md:flex gap-6">
              <div className="flex gap-3 items-center mb-4 md:mb-0 md:flex-col md:items-center md:w-40 md:flex-shrink-0">
                <img src="https://zinzinowebstorage.blob.core.windows.net/productimages/large/300000.png"
                  alt="Zinzino BalanceOil+ Oméga-3" loading="lazy"
                  className="w-16 h-20 md:w-24 md:h-28 object-contain bg-white rounded-xl p-1 border border-emerald-100 flex-shrink-0"
            ...
            <a href="https://www.zinzino.com/2020929659" target="_blank" rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 w-full bg-emerald-800 hover:bg-emerald-900 text-white py-3 rounded-xl text-sm font-medium transition-colors mt-4">
              <ShoppingBag className="w-4 h-4" />
              Commander sur Zinzino — prix partenaire avantageux
            ...
            <div className="mt-3 flex items-center gap-2.5 bg-white border border-emerald-100 rounded-xl p-3">
              ...
              <a href="https://www.zinzino.com/2020929659" target="_blank" rel="noopener noreferrer"
                className="bg-emerald-50 text-emerald-700 border border-emerald-200 text-xs px-3 py-1.5 rounded-full font-medium hover:bg-emerald-100 transition-colors whitespace-nowrap">
                Voir →
              </a>
            </div>
          </motion.div>
      ...
      <section className="px-5 md:px-8 py-6 max-w-5xl mx-auto">
        ...
        <p className="text-sm text-gray-500 leading-relaxed mb-4">
          Accessoires, jouets et t-shirts originaux pour chérir votre félin et afficher votre passion avec style.
        </p>
        <motion.div variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true }}
          ...
          <ProdCard img="https://felinejoycamy.myshopify.com/cdn/shop/files/13315842307128167536_2048.jpg?v=1774202108&width=400"
            name="Stay Weird Stay Wild" sub="T-shirt rétro unisexe" price="~14€" star
          ...
          <ProdCard img="https://felinejoycamy.myshopify.com/cdn/shop/files/3106667881955.jpg?v=1770412974&width=400"
            name="Cozy Cave Cat Bed" sub="Niche douillette pompom" price="~19€"
          ...
          <ProdCard img="https://felinejoycamy.myshopify.com/cdn/shop/files/data_dd19f71b-8e59-4d10-b92b-6f0e5686c97a.jpg?v=1770414077&width=400"
            name="Crazy Cat Lady" sub="100% coton premium" price="~17€"
          ...
          <ProdCard img="https://felinejoycamy.myshopify.com/cdn/shop/files/data_b7f70288-c0a0-4b26-8fc5-a0d8315e5fcb.png?v=1770408141&width=400"
            name="Jouet plume rotatif" sub="USB rechargeable auto" price="~13€"
      ...
      <section className="px-5 md:px-8 py-6 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-sm text-gray-500 leading-relaxed mb-4 max-w-2xl">
            La science confirme ce que nous ressentons : notre lien avec nos animaux nous transforme profondément — corps, esprit et cœur.
          </p>
          <div className="md:flex gap-6 mb-5">
            <div className="relative rounded-2xl overflow-hidden h-48 md:h-64 md:w-96 flex-shrink-0 mb-4 md:mb-0">
              <img src="https://images.unsplash.com/photo-1548802673-380ab8ebc7b7?w=800&q=80"
                alt="Personne enlacant son chat" loading="lazy" className="w-full h-full object-cover"
              ...
              <p className="absolute bottom-3 left-3 right-3 text-white text-xs italic leading-relaxed"
            ...
            <div className="flex-1">
              ...
              <div className="bg-white border border-violet-100 rounded-2xl p-4">
                ...
                <p className="text-xs text-gray-500 leading-relaxed mb-2">
                  Parlez à votre chat avec douceur aujourd'hui. Observez comment il réagit à votre ton — pas vos mots.
                </p>
      ...
      {amazonArticles.length > 0 && (
        <section className="px-5 md:px-8 py-6 max-w-5xl mx-auto">
          ...
          <p className="text-sm text-gray-500 leading-relaxed mb-4">
            Des produits sélectionnés en lien avec nos articles — bien-être humain et animal.
          </p>
      ...
      <footer className="bg-emerald-900 text-white px-5 md:px-8 py-8 mt-2">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-2.5 md:justify-center md:max-w-sm md:mx-auto">
            <a href="https://www.zinzino.com/2020929659" target="_blank" rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 bg-emerald-700 hover:bg-emerald-600 text-white py-3 px-6 rounded-xl text-sm font-medium transition-colors">
              <ExternalLink className="w-3.5 h-3.5" />Boutique Zinzino
            </a>
            <a href="https://felinejoycamy.myshopify.com" target="_blank" rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 bg-amber-600 hover:bg-amber-500 text-white py-3 px-6 rounded-xl text-sm font-medium transition-colors">
