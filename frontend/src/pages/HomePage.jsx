...
const ProdCard = ({ img, name, sub, Voir le prix , star, link }) => (
  <a href={link || "https://felinejoycamy.myshopify.com"} target="_blank" rel="noopener noreferrer"
    ...
    <div className="p-2.5">
      ...
      <div className="text-sm font-medium text-amber-700 mt-1.5">{Voir le prix →}</div>
    </div>
  </a>
);
      ...
      <div className="min-h-screen bg-stone-50">
        ...
        <section className="px-5 md:px-8 py-6 max-w-5xl mx-auto">
          ...
          <motion.div variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true }} className="grid grid-cols-2 md:grid-cols-4 gap-3">
            <ProdCard img="https://felinejoycamy.myshopify.com/cdn/shop/files/13315842307128167536_2048.jpg?v=1774202108&width=400" name="Stay Weird Stay Wild" sub="T-shirt rétro unisexe" Voir le prix →="Voir le prix →" star link="https://felinejoycamy.myshopify.com/products/unisex-garment-dyed-t-shirt" />
            <ProdCard img="https://felinejoycamy.myshopify.com/cdn/shop/files/3106667881955.jpg?v=1770412974&width=400" name="Cozy Cave Cat Bed" sub="Niche douillette pompom" Voir le prix →="~19€" link="https://felinejoycamy.myshopify.com/products/lit-cocooning-pour-chat-niche-douillette-avec-pompon-couchage-premium" />
            <ProdCard img="https://felinejoycamy.myshopify.com/cdn/shop/files/data_dd19f71b-8e59-4d10-b92b-6f0e5686c97a.jpg?v=1770414077&width=400" name="Crazy Cat Lady" sub="100% coton premium" Voir le prix →="Voir le prix →" link="https://felinejoycamy.myshopify.com/products/t-shirt-crazy-cat-lady-100-coton-premium-cadeau-parfait-maman-chat" />
            <ProdCard img="https://felinejoycamy.myshopify.com/cdn/shop/files/data_b7f70288-c0a0-4b26-8fc5-a0d8315e5fcb.png?v=1770408141&width=400" name="Jouet plume rotatif" sub="USB rechargeable auto" Voir le prix →="~13€" link="https://felinejoycamy.myshopify.com/products/jouet-interactif-chat-culbuto-balle-oscillante-stimulante-auto-amusement" />
          </motion.div>
